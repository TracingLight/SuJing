...
title: 溯境
top_img: false
description: 溯光如初的长期个人博客，以游戏开发与 Unity 技术为主，也记录音乐、生活、兴趣与沿途经验。
aside: false
comments: false
type: sujing-home
---
...
<div class="sujing-home sujing-bento-home" data-sujing-home>
  <a class="sujing-now-strip" href="/notes/" data-sujing-reveal>
    <span><i class="fas fa-bolt" aria-hidden="true"></i> 即时短讯</span>
    <strong data-sujing-home-note>溯境第一版开始构建，技术、作品、生活与兴趣都会在这里留下记录。</strong>
  ...
  <section class="sujing-bento-hero" aria-labelledby="sujing-home-title" data-sujing-reveal>
    ...
    <div class="sujing-bento-hero-copy">
      <p class="sujing-kicker">SUJING · WORLD LOG 001</p>
      <h1 id="sujing-home-title">溯境</h1>
      <p>在代码与世界之间持续构筑。以 Unity 游戏客户端开发为主线，也记录生活、兴趣与沿途形成的判断。</p>
      <div class="sujing-home-actions">
        <a class="sujing-button sujing-button-primary" href="/articles/"><span>进入文章库</span><i class="fas fa-arrow-right" aria-hidden="true"></i></a>
        <button class="sujing-button sujing-button-quiet" type="button" data-sujing-command-open><i class="fas fa-compass" aria-hidden="true"></i><span>探索溯境</span></button>
      </div>
    </div>
    <div class="sujing-bento-hero-meta" aria-hidden="true"><span>UNITY</span><span>RENDER</span><span>LIFE</span></div>
  </section>
  ...
  <div class="sujing-bento-grid">
    ...
    <section class="sujing-bento-card sujing-bento-tracks" aria-labelledby="sujing-tracks-title" data-sujing-reveal>
      <header><p class="sujing-kicker">KNOWLEDGE TRACKS</p><h2 id="sujing-tracks-title">技术主线</h2></header>
      <nav aria-label="技术主题">
    ...
    <section class="sujing-bento-card sujing-bento-gallery" aria-labelledby="sujing-gallery-title" data-sujing-reveal>
      <header>
        <div><p class="sujing-kicker">VISUAL ARCHIVE</p><h2 id="sujing-gallery-title">世界切片</h2></div>
        <a href="/gallery/">进入相册 <i class="fas fa-arrow-right" aria-hidden="true"></i></a>
      </header>
    ...
    <aside class="sujing-bento-side" aria-label="站点动态">
      <a class="sujing-bento-card sujing-bento-note" href="/notes/" data-sujing-reveal>
        <div><p class="sujing-kicker">FIELD NOTE</p><time data-sujing-home-note-time datetime="2026-07-21">2026.07.21</time></div>
        <h2>此刻的记录</h2>
        <p data-sujing-home-note>溯境第一版开始构建，技术、作品、生活与兴趣都会在这里留下记录。</p>
        <span>查看全部短讯 <i class="fas fa-arrow-right" aria-hidden="true"></i></span>
      </a>
      <a class="sujing-bento-card sujing-bento-profile" href="/about/" data-sujing-reveal>
        ...
        <div><p class="sujing-kicker">ABOUT THE BUILDER</p><h2>溯光如初</h2><span>Unity 游戏客户端开发 · 长期学习者</span></div>
        <i class="fas fa-arrow-right" aria-hidden="true"></i>
      </a>
    </aside>
  </div>
  ...
  <nav class="sujing-bento-destinations" aria-label="内容目的地">
    <a href="/articles/" data-sujing-reveal><span>01</span><div><strong>文章库</strong><small>技术与长期写作</small></div><i class="fas fa-book-open" aria-hidden="true"></i></a>
    <a href="/archives/" data-sujing-reveal><span>02</span><div><strong>归档</strong><small>沿时间回看记录</small></div><i class="fas fa-clock-rotate-left" aria-hidden="true"></i></a>
    <a href="/gallery/" data-sujing-reveal><span>03</span><div><strong>相册</strong><small>视觉与生活切片</small></div><i class="fas fa-images" aria-hidden="true"></i></a>
    <a href="/about/" data-sujing-reveal><span>04</span><div><strong>关于</strong><small>作者与建站方向</small></div><i class="fas fa-user" aria-hidden="true"></i></a>
  </nav>
</div>
